...
const Items = { id: 39, postBody: { body }, title: 'Заголовок 9', date: "07.04.2019" };
...
class App extends React.Component {
  ...
  AddItems() {
    this.setState({
      blogList: this.state.blogList.push(Items)
    })
  ...
  render() {
    return (
      <>
        ...
        <WelcomeModal />
        <button onClick={this.AddItems.bind(this)}>Добавить запись</button>
      </>
    );
  }
}
